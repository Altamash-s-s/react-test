...
function App() {
    ...
    // Enquire Form  All field validation error hide code 
    const handleFocus = e => {
    ...
    // Enquire Form  Phone field validation error hide code    
    ...
    const sendEmail = async (e) => {
        ...
        if (name_fld_glb == '') {
            ...
            if (dprt_fld_glb === 'Leasing') {
                    ...
                    fetch('https://script.google.com/macros/s/AKfycbx1VjbZ_gfx_OfppiJyIzRMH-eBtvWhiS9WPb8VSvMHj5uwE4_da0tziLWfV2inUG8H/exec', {
                        method: 'POST',
                    ...
                    emailjs.sendForm('service_e420df4', 'template_qxw1h39', e.target, 'SsPYHKCapw4h-xBn_')
                        .then((result) => {
                ...
                emailjs.sendForm('service_e420df4', 'template_0rku4hn', e.target, 'SsPYHKCapw4h-xBn_')
                    .then((result) => {
                ...
                emailjs.sendForm('service_e420df4', 'template_o4u61xa', e.target, 'SsPYHKCapw4h-xBn_')
                    .then((result) => {
                ...
                emailjs.sendForm('service_e420df4', 'template_0svsn5t', e.target, 'SsPYHKCapw4h-xBn_')
                    .then((result) => {
                ...
                emailjs.sendForm('service_e420df4', 'template_a76d30l', e.target, 'SsPYHKCapw4h-xBn_')
                    .then((result) => {
...
const bk_vst_sendEmail = async (e) => {
    ...
    if (locat_fld_bk_vst == '') {
        ...
        fetch('https://script.google.com/macros/s/AKfycbxg37VAUtKWvT0jKRStPB-b2pvgSY5oUdN8r61Umd2IMWADbiLRGYrm-WQ20uFjx_AIlg/exec', {
            method: 'POST',
        ...
        emailjs.sendForm('service_e420df4', 'template_8xqcdvi', e.target, 'SsPYHKCapw4h-xBn_')
            .then((result) => {
...
//---------------------------------------------------------------------------------------- Book Visit Form code END
    ...
    $(document).ready(function () {
        ...
        if (url === '/parks/goa' || url === '/parks/Goa' || url === '/parks/GOA') {
            window.location.href = "/parks/verna";
        }
        if (url === '/parks/Delhi-NCR' || url === '/parks/Delhi_NCR' || url === '/parks/DELHI_NCR' || url === '/parks/DELHI_NCR' || url === '/parks/DELHI-NCR' || url === '/parks/delhi-ncr' || url === '/parks/delhi_ncr' || url === '/parks/Delhi_ncr') {
            window.location.href = "/parks/farukhnagar";
        }
        if (url === '/parks/pune' || url === '/parks/PUNE' || url === '/parks/Pune') {
            window.location.href = "/parks/chakan-ii";
        }
        if (url === '/parks/Ahmedabad' || url === '/parks/AHMEDABAD' || url === '/parks/ahmedabad') {
            window.location.href = "/parks/bhayala";
        }
        if (url === '/parks/Hyderabad' || url === '/parks/HYDERABAD' || url === '/parks/hyderabad') {
            window.location.href = "/parks/kothur";
        }
        if (url === '/parks/Bengaluru' || url === '/parks/BENGALURU' || url === '/parks/bengaluru') {
            window.location.href = "/parks/dobbaspet-i";
        }
     
        

        if (url === '/parks/farukhnagar') {
            let pg_name = 'Farukhnagar page';
            $('#enquiry_page_name').val(pg_name);
            $('#site_visit_page_name').val(pg_name);
        ...
        <>
            ...
            <BrowserRouter>
                ...
                <Routes>
                    ...
                    <Route exact path="/parks" element={<Park_page />} />
                    <Route exact path="/parks/:slug" element={<Park_inside_page />} />
                    <Route path="/search/:name" element={<Search_page />} />
                    <Route path="/explore" element={<Explore_page />} />
                    <Route path="/sustainability" element={<Esg_page />} />
                    <Route path='/solutions' element={<Solution_page />} />
                    <Route path='/solutions/strategic-land-acquisition' element={<Strategic_land_acquisition_page />} />
                    <Route path='/solutions/property-management' element={<Property_management_page />} />
                    <Route path='/solutions/park-construction-and-development' element={<Park_const_developed_page />} />
                    <Route path='/solutions/park-compliances-and-approvals' element={<Park_comp_app_page />} />
                    
                    <Route path='/contact' element={<Contact_page />} />
                    <Route path='*' element={<Error_page />} />

                    <Route path='/Not-found' element={<Error_page />} />
                    <Route path='/press_release/:slug' element={<Press_release_page />} />
                    <Route path='/privacy_policy' element={<Privacy_policy />} />
                    <Route path='/disclaimer' element={<Disclaimer_page />} />

                    <Route path='/blogs' element={<Blog_page />} />
                    <Route path='/blogs/:slug' element={<Blog_inside_page />} />
                    <Route path='/blogs/category/:id' element={<Blog_category_page />} />
                    <Route path='/blogs/tags/:id' element={<Blog_tags_page />} />
                    <Route path='/client-stories' element={<Client_page />} />
                    <Route path='/client-stories/:slug' element={<Client_inside_pg />} />
                    <Route path='/event' element={<Event_page />} />
                    <Route path='/event/:slug' element={<Event_page />} />
            ...
            <div className='enquire_from_div'>
                ...
                <div className='enquire_from'>
                    ...
                    <form className="row g-3 conversion_form enquire_global_form" ref={form_glb} onSubmit={sendEmail} id='enq_form_bx'>

                        <input className='page_name' type='hidden' name='Page_name' id='enquiry_page_name' />

                        <input className='current_date' type='hidden' name='Date' id='enquiry_current_date' />

                        <div className="col-xl-6 col-lg-12 col-md-12 col-12 conv_frm_spc">
                            <label className="form-label conv_frm_label" >Name</label>
                            <input type="text" name='name' className="form-control" id='name_fld_glb' ref={nameinput_glb} onFocus={handleFocus} />
                            <p className='error_msg' id='nm_err_frmglb'>Please Enter Name</p>
                        </div>
                        <div className="col-xl-6 col-lg-12  col-md-12 col-12 conv_frm_spc">
                            <label className="form-label">Email Address</label>
                            <input type="email" name='email' className="form-control" id='email_fld_glb' ref={emailinput_glb} onFocus={handleFocus} />
                            <p className='error_msg' id='eml_err_frmglb'>Please Enter Email Address</p>
                            <p className='error_msg' id='eml_err1_frmglb'>Please Enter Valid Email</p>
                        </div>
                        <div className="col-xl-6 col-lg-12  col-md-12 col-12 conv_frm_spc">
                            <label className="form-label">Organisation</label>
                            <input type="text" name='organisation' className="form-control" id='org_fld_glb' ref={orginput_glb} onFocus={handleFocus} />
                            <p className='error_msg' id='cmp_err_glb'>Please Enter Organisation</p>
                        </div>
                        <div className="col-xl-6 col-lg-12 col-md-12 col-12 conv_frm_spc">
                            <label className="form-label">Phone No</label>
                            <input type="number" name='phone' className="form-control" id='phone_fld_glb' ref={phoneinput_glb} onFocus={handleFocus11} />
                            <p className='error_msg' id='phn_err_glb'>Please Enter Phone Numbers</p>
                            <p className='error_msg' id='phn_err1_glb'>Please Enter Valid Phone Numbers</p>
                        </div>

                        <div className='col-12 conv_frm_spc select_drp'>
                            <label className="form-label">Type of Enquiry</label>
                            <select className='form-control enq_frm_slct enq_global_form cont_enq' name='enquiry' id='dprt_fld_glb' ref={departinput_glb} onFocus={handleFocus}>
                                <option value="" disabled selected>Select Type of Enquiry</option>
                                <option value="Leasing">Leasing</option>
                                <option value="Land & Warehouse Investments">Land {'&'} Warehouse Investments</option>
                                <option value="HR & Admin">HR {'&'} Admin</option>
                                <option value="Media / Marketing">Media / Marketing</option>
                                <option value="Projects & Development">Projects {'&'} Development</option>
                            </select>
                            <p className='error_msg' id='depart_err_glb'>Please Select Type of Enquiry</p>
                        </div>

                        <div className="col-md-6 conv_frm_spc pkr_lc_fld_dv">
                            <label className="form-label conv_frm_label" >Park location</label>
                            <input type="text" name='park_location' className="form-control" id='park_lsng_fld' ref={parkinput_lsng} onFocus={handleFocus} />
                            <p className='error_msg' id='prk_err_lsng_glb'>Please Enter Park Location</p>
                        </div>
                        <div className="col-md-6 conv_frm_spc spc_rq_fld_dv">
                            <label className="form-label conv_frm_label" >Space Required</label>
                            <input type="text" name='space_required' className="form-control" id='space_lsng_fld' ref={spaceinput_lsng} onFocus={handleFocus} placeholder="1,00,000 SQFT" />
                            <p className='error_msg' id='spc_err_lsng_glb'>Please Enter Space</p>
                        </div>
                        ...
                        <div className="col-12 conv_frm_spc">
                            ...
                            <textarea className="form-control req_txt" name='message' id='msg_fld_glb' placeholder="Enter your message" ref={msginput_glb} onFocus={handleFocus} rows="4" cols="50"></textarea>
                            <p className='error_msg' id='msg_err_tellglb'>Please Enter Message</p>
                        </div>

                        <div className="col-12 btn_col">
                            <input type="submit" className="btn btn-primary conv_btn cont_form_btn" value='Submit'></input>
                        </div>
                    </form>

                    <p className='thnk txt_wht' id='thnk_box1'>Your form has been sent successfully</p>
            ...
            <div className='book_visit_from_div'>
                ...
                <div className='enquire_from'>
                    ...
                    <form className="row g-3 conversion_form enquire_global_form" ref={bk_vst_form_glb} onSubmit={bk_vst_sendEmail} id='book_vst_form_bx'>

                        <input className='page_name' type='hidden' name='Page_name' id='site_visit_page_name' />

                        <div className='col-xl-6 col-lg-12 col-md-12 col-12 conv_frm_spc select_drp'>
                            <label className="form-label">Location</label>
                            <select className='form-control enq_frm_slct enq_global_form cont_enq' name='location' id='locat_fld_bk_vst' ref={locationinput_bk_vst} onFocus={handleFocus_bkvst}>
                                ...
                                <option value="Bilaspur-I">Bilaspur I</option>
                            ...
                            <p className='error_msg' id='locat_err_bk_vst'>Please Select Park</p>
                        </div>
                        ...
                        <div className="col-xl-6 col-lg-12 col-md-12 col-12 conv_frm_spc">
                            ...
                            <input type="date" className="form-control" name="date" id='date_fld_bk_vst' ref={dateinput_bk_vst} onFocus={handleFocus_bkvst}/>
                            <p className='error_msg' id='date_err_bk_vst'>Please Enter Date</p>
                        </div>

                        <div className='col-xl-12 col-lg-12 col-md-12 col-12 conv_frm_spc select_drp'>
                            <label className="form-label">Sector</label>
                            <select className='form-control enq_frm_slct enq_global_form cont_enq' name='sector' id='sector_fld_bk_vst' ref={sectorinput_bk_vst} onFocus={handleFocus_bkvst}>
                            ...
                            <p className='error_msg' id='sector_err_bk_vst'>Please Select Sector</p>
                        </div>
                        ...
                        <div className="col-xl-6 col-lg-12 col-md-12 col-12 conv_frm_spc">
                            <label className="form-label conv_frm_label" >Name</label>
                            <input type="text" name='name' className="form-control" id='name_fld_bk_vst' ref={nameinput_bk_vst} onFocus={handleFocus_bkvst} />
                            <p className='error_msg' id='nm_err_bk_vst'>Please Enter Name</p>
                        </div>
                        <div className="col-xl-6 col-lg-12  col-md-12 col-12 conv_frm_spc">
                            <label className="form-label">Email Address</label>
                            <input type="email" name='email' className="form-control" id='email_fld_bk_vst' ref={emailinput_bk_vst} onFocus={handleFocus_bkvst} />
                            <p className='error_msg' id='eml_err_bk_vst'>Please Enter Email Address</p>
                            <p className='error_msg' id='eml_err1_bk_vst'>Please Enter Valid Email</p>
                        </div>
                        <div className="col-xl-6 col-lg-12 col-md-12 col-12 conv_frm_spc">
                            <label className="form-label">Phone No</label>
                            <input type="number" name='phone' className="form-control" id='phone_fld_bk_vst' ref={phoneinput_bk_vst} onFocus={handleFocus_bkvst1} />
                            <p className='error_msg' id='phn_err_bk_vst'>Please Enter Phone Numbers</p>
                            <p className='error_msg' id='phn_err1_bk_vst'>Please Enter Valid Phone Numbers</p>
                        </div>
                        <div className="col-xl-6 col-lg-12  col-md-12 col-12 conv_frm_spc">
                            <label className="form-label">Organisation</label>
                            <input type="text" name='organisation' className="form-control" id='org_fld_bk_vst' ref={orginput_bk_vst} onFocus={handleFocus_bkvst} />
                            <p className='error_msg' id='org_err_bk_vst'>Please Enter Organisation</p>
                        </div>
                        
                        <div className="col-12 conv_frm_spc">
                            <label className="form-label">Tell Us More</label>
                            {/* <input type="text" className="form-control" id='msg_fld' placeholder="Enter your message" ref={msginput} onFocus={handleFocus}/> */}
                            <textarea className="form-control req_txt" name='message' id='msg_fld_bk_vst' placeholder="Enter your message" ref={msginput_bk_vst} onFocus={handleFocus_bkvst} rows="4" cols="50"></textarea>
                            <p className='error_msg' id='msg_err_bk_vst'>Please Enter Message</p>
                        </div>
                    ...
                    <p className='thnk txt_wht' id='thnk_box_bk_vst'>Your Booking Confirmed</p>
