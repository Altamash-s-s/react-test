...
export default function Blog_featureslider() {
    ...
    console.log("First date of current month:", firstDateOfCurrentMonth);
    console.log("First date of next month:", firstDateOfNextMonth);
            ...
            >
                ...
                {/* <SwiperSlide>
                    <div className='blog_feat_sld'  >
                        <a target='_blank' href='blogs/blog_inside_page'>
                            <div className='blg_main_container'>
                                <div className='blg-custm-contain'>
