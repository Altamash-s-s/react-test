            ...
            if (dprt_fld == '') {
                ...
                if (dprt_fld === 'bilaspur') {
                    ...
                    if (prk_pdf === 'ENVIRONMENT CLEARANCE') {
                        ...
                        fetch('https://script.google.com/macros/s/AKfycbyXO9hfsXvjUFKheLMngGnwlsvV2hMuYGcCxIBbaNs-gRqaaxtep3aEX_DsYIz9lTg-ng/exec', {
                            method: 'POST',
                        ...
                        emailjs.sendForm('service_e420df4', 'template_nvksf0m', e.target, 'SsPYHKCapw4h-xBn_')
                            .then((result) => {
                                ...
                                var report_url = 'https://www.hiparks.com//compliance_report/Bilaspur/Environmet%20Clearance.pdf';
                        ...
                        emailjs.sendForm('service_e420df4', 'template_nvksf0m', e.target, 'SsPYHKCapw4h-xBn_')
                            .then((result) => {
                                ...
                                var report_url = 'https://www.hiparks.com/compliance_report/Bilaspur/Six_Monthly_Compliance_Dec_2020.pdf';
                                window.open(report_url, '_blank');
                        ...
                        emailjs.sendForm('service_e420df4', 'template_nvksf0m', e.target, 'SsPYHKCapw4h-xBn_')
                            .then((result) => {
                                ...
                                var report_url = 'https://www.hiparks.com/compliance_report/Bilaspur/Six_Monthly_Compliance_Dec_2021.pdf';
                                window.open(report_url, '_blank');
                        ...
                        emailjs.sendForm('service_e420df4', 'template_nvksf0m', e.target, 'SsPYHKCapw4h-xBn_')
                            .then((result) => {
                                ...
                                var report_url = 'https://www.hiparks.com/compliance_report/Bilaspur/Six_Monthly_Compliance_June_2021.pdf';
                                window.open(report_url, '_blank');
                        ...
                        emailjs.sendForm('service_e420df4', 'template_nvksf0m', e.target, 'SsPYHKCapw4h-xBn_')
                            .then((result) => {
                                ...
                                var report_url = 'https://www.hiparks.com/compliance_report/Bilaspur/Six_Monthly_Compliance_June_2022.pdf';
                                window.open(report_url, '_blank');
                    ...
                    if (prk_pdf === 'ENVIRONMENT CLEARANCE') {
                        ...
                        emailjs.sendForm('service_e420df4', 'template_nvksf0m', e.target, 'SsPYHKCapw4h-xBn_')
                            .then((result) => {
                                ...
                                var report_1_url = 'https://www.hiparks.com/compliance_report/Farukhnagar/Environment%20clearance.pdf';
                        ...
                        emailjs.sendForm('service_e420df4', 'template_nvksf0m', e.target, 'SsPYHKCapw4h-xBn_')
                            .then((result) => {
                                ...
                                var report_1_url = 'https://www.hiparks.com/compliance_report/Farukhnagar/Six_Monthly_Compliance_Dec_20.pdf';
                                window.open(report_1_url, '_blank');
                        ...
                        emailjs.sendForm('service_e420df4', 'template_nvksf0m', e.target, 'SsPYHKCapw4h-xBn_')
                            .then((result) => {
                                ...
                                var report_1_url = 'https://www.hiparks.com/compliance_report/Farukhnagar/Six_Monthly_Compliance_Dec_21.pdf';
                                window.open(report_1_url, '_blank');
                        ...
                        emailjs.sendForm('service_e420df4', 'template_nvksf0m', e.target, 'SsPYHKCapw4h-xBn_')
                            .then((result) => {
                                ...
                                var report_1_url = 'https://www.hiparks.com/compliance_report/Farukhnagar/Six_Monthly_Compliance_June_21.pdf';
                                window.open(report_1_url, '_blank');
                        ...
                        emailjs.sendForm('service_e420df4', 'template_nvksf0m', e.target, 'SsPYHKCapw4h-xBn_')
                            .then((result) => {
                                ...
                                var report_1_url = 'https://www.hiparks.com/compliance_report/Farukhnagar/Six_Monthly_Compliance_June_22.pdf';
                                window.open(report_1_url, '_blank');
                    ...
                    if (prk_pdf === 'ENVIRONMENT CLEARANCE') {
                        ...
                        emailjs.sendForm('service_e420df4', 'template_nvksf0m', e.target, 'SsPYHKCapw4h-xBn_')
                            .then((result) => {
                                ...
                                var report_2_url = 'https://www.hiparks.com/compliance_report/Hosur/Environment%20Clearance.pdf';
                        ...
                        emailjs.sendForm('service_e420df4', 'template_nvksf0m', e.target, 'SsPYHKCapw4h-xBn_')
                            .then((result) => {
                                ...
                                var report_2_url = 'https://www.hiparks.com/compliance_report/Hosur/Six_Monthly_Compliance_Dec_20.pdf';
                        ...
                        emailjs.sendForm('service_e420df4', 'template_nvksf0m', e.target, 'SsPYHKCapw4h-xBn_')
                            .then((result) => {
                                ...
                                var report_2_url = 'https://www.hiparks.com/compliance_report/Hosur/Six_Monthly_Compliance_Dec_21.pdf';
                        ...
                        emailjs.sendForm('service_e420df4', 'template_nvksf0m', e.target, 'SsPYHKCapw4h-xBn_')
                            .then((result) => {
                                ...
                                var report_2_url = 'https://www.hiparks.com/compliance_report/Hosur/Six_Monthly_Compliance_June_21.pdf';
                        ...
                        emailjs.sendForm('service_e420df4', 'template_nvksf0m', e.target, 'SsPYHKCapw4h-xBn_')
                            .then((result) => {
                                ...
                                var report_2_url = 'https://www.hiparks.com/compliance_report/Hosur/Six_Monthly_Compliance_June_22.pdf';
        ...
        <>
            <div className='report_sec snap_sec mob_pd_LR tab_pd_LR'>
                <div className='cstm_container '>
                    ...
                    <div className='row'>
                        <div className='col-lg-6 col-md-6 col-12 compliance_reports'>
                            <h2 className='report_sec_heading p_opacity' ref={cta_aniamtion} id='cta_aniamtion'>DOWNLOAD <br />COMPLIANCE REPORTS</h2>
                        </div>

                        <div className='col-lg-6 col-md-6 col-12 enq_col'>


                            {/* contact Form start here */}
                            <div className='dwnreport_form'>

                                <form className="row g-3 dwn_rpt_frm conversion_form main_form report_form" ref={form} onSubmit={requestOTP} id='enq_form_bx'>

                                <input className='page_name' type='hidden' name='Page_name' id='' value='Sustainability Page' />
                                    <input className='current_date' type='hidden' name='Date' id='report_current_date' />


                                    <div className='col-lg-6 col-md-12 col-12 conv_frm_spc selectin-fld'>
                                        <label className="form-label">Select Park</label>

                                        <select className='form-control report_control enq_type' name='enquiry' id='dprt_fld' ref={departinput} onFocus={handleFocus} >
                                        ...
                                        <p className='error_msg' id='depart_err'>Please Select Park</p>
                                    </div>

                                    <div className='col-lg-6 col-md-12 col-12 conv_frm_spc selectin-fld'>
                                        <label className="form-label">Select Report</label>

                                        <select className='form-control report_control enq_type' name='enquiry' id='dprt_fld_rpt' ref={departpdfinput} onFocus={handleFocus} >

                                            <option value="" disabled>Select Report</option>

                                            <option value="bilaspur">ENVIRONMENT CLEARANCE</option>
                                            <option value="bilaspur">COMPLIANCE REPORT DEC-2020</option>
                                            <option value="bilaspur">COMPLIANCE REPORT DEC-2021</option>
                                            <option value="bilaspur">COMPLIANCE REPORT JUNE-2021</option>
                                            <option value="bilaspur">COMPLIANCE REPORT JUNE-2022</option>
                                            <option value="farukhnagar">ENVIRONMENT CLEARANCE</option>
                                            <option value="farukhnagar">COMPLIANCE REPORT DEC-2020</option>
                                            <option value="farukhnagar">COMPLIANCE REPORT DEC-2021</option>
                                            <option value="farukhnagar">COMPLIANCE REPORT JUNE-2021</option>
                                            <option value="farukhnagar">COMPLIANCE REPORT JUNE-2022</option>
                                    ...
                                    <div className="col-md-6 col-12 conv_frm_spc">
                                        <label className="form-label conv_frm_label name-label" >NAME</label>
                                        <input type="text" name='name' className="form-control name-control" id='name_fld' ref={nameinput} onFocus={handleFocus} />
                                    ...
                                    <div className="col-md-6 col-12 conv_frm_spc">
                                        ...
                                        <input type="email" name='email' className="form-control" id='email_fld' ref={emailinput} onFocus={handleFocus} />
                                    ...
                                    <div className="col-lg-8 col-md-12 col-12 conv_frm_spc">
                                        ...
                                        <input type="tel" name='phone' className="form-control" id='phone_fld' ref={phoneinput} onFocus={handleFocus1} value={phoneNumber} onChange={(e) => setPhoneNumber(e.target.value)} />

                                        <p className='error_msg' id='phn_err'>Please Enter Phone No</p>
                                        <p className='error_msg' id='phn_err1'>Please Enter Valid Phone No</p>

                                        <button type="submit" className="snd_otp sending_otp" value="Submit" onClick={() => (state.button = 1)}>send otp{'>'}</button>
                                    ...
                                    <div className="col-lg-4 col-md-12 col-12 conv_frm_spc">
                                        ...
                                        <input type="number" className="form-control cstm_frm otp_fld report_otp" id='otpInput' placeholder="enter otp" value={OTP} onChange={verifyOTP}></input>

                                        <p className='error_msg otp_error ' id='otp_err'>Please Enter Valid OTP</p>
                                        <p className='otp_succ txt_crl' id='otp_succ'>OTP Verified</p>
                                        <p className='otp_msg txt_crl' id='otp_msg'>OTP has been sent.</p>
                                    </div>
                                    ...
                                    <div className='col-lg-12 col-md-12 col-12'>
                                        ...
                                        <button className='report_btn isDisabled' id='download_btn' type="submit" value="Submit" onClick={() => (state.button = 2)}>
                                            Download Report<img className="dnld_icon" src={require('../../assets/img/svg/ESG/report_icon.svg').default} ></img>
                                        </button>
                                ...
                                <p className='thnk txt_wht' id='thnk_box'>Thank you for downloading the report.</p>
