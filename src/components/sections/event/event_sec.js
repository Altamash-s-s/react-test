...
export default function Event_sec() {
    ...
    useEffect(() => {
        ...
        // $(".event_sec").pagify(2, ".event_box_col");
            ...
            <div className='cstm_container'>
                ...
                <div className='row event_pg_col'>
                        ...
                        <div className='col-12 event_descp'>
                            <p class="sub_para ovrview_subpara">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                        </div>
                            ...
                            <div className='col-lg-6 col-md-6 col-12 event_box_col js-filterable ADD' key={id} >
                                <Link to={slug} >
                                    <div className='event_box'  >
                                        ...
                                        <h3 className='event_hd' dangerouslySetInnerHTML={{ __html: content.rendered }}></h3>  
