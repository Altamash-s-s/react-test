...
export default function Address_sec() {
    ...
    return (
        <>
            <div class="address_sec snap_sec">
                <div class="row no_LR_margin iteg_row">
                    <div class="col-lg-6 col-md-12 col-12 addrss_col_1">
                        {/* <h2 className='addrss-hdng section_heading'>Reach us</h2> */}
                            ...
                            <h6 className='para no-mrgin'>Tejas Prasad</h6>
                            <a className='para' href="tel:+917090773458">+91 7090773458 | </a> <a className='para' href="mailto:tejas.prasad@hiparks.com">tejas.prasad@hiparks.com</a> <br></br>

                            <h5 className='grand_para'>West Region</h5>                            
                            <h6 className='para no-mrgin'>Muktesh Sheth</h6>
                            <a className='para' href="tel:+919790655533">+91 99229 56032 | </a> <a className='para' href="mailto:muktesh.sheth@HiParks.com">muktesh.sheth@HiParks.com</a>
                    ...
                    <div class="col-lg-6 col-md-12 col-12 addrss_col_2">
