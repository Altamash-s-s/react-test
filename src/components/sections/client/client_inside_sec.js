                    ...
                    <div className='cstm_container'>
                        <div className='row no_LR_margin'>
                            ...
                            <div className='col-lg-7 col-md-7 col-12 ovrview_col cstm'>
                                ...
                                <h2 className='section_sub_heading ovrview_sub_hd' dangerouslySetInnerHTML={{ __html: acf.overview_title }}></h2>

                                <p className='para ovrview_para clnt_ovrw_para' dangerouslySetInnerHTML={{ __html: acf.overview_paragraph }}></p>
                            ...
                            <div className='col-lg-5 col-md-5 col-12 cc_overvw_patch'>
                                ...
                                <div className='ovrview_div'>
                                    ...
                                    <div className='ovr_lnd_area_spc sector_prt'>
                                        <p className='ovrview_subpoints' dangerouslySetInnerHTML={{ __html: acf.sector_title }}></p>
                                        <p className='ovrview_subpoints_sub_heading cstm' dangerouslySetInnerHTML={{ __html: acf.sector_paragraph }}></p>
                                    </div>
                        ...
                        <div className='row no_LR_margin looker_row'>
                            ...
                            <div className='col-12'>
                                ...
                                {/* <p className='section_sub_heading ovrview_sub_hd'>Overview</p> */}
                                <h2 className='section_sub_heading ovrview_sub_hd ovr_sub_hd'  dangerouslySetInnerHTML={{ __html: acf.closer_titile }}></h2>
                                <p className='para ovrview_para clnt_ovrw_para' dangerouslySetInnerHTML={{ __html: acf.closer_paragraph }}></p>
                                    ...
                                    <div className='content-box'>
                                        ...
                                        {acf.glance_details.map((glance_sub)=>
                                            <div className='box-one' key={id}>
                                                <div className='infg_box_inner'>
                                                    <img className='box_img'  alt={acf.image_alt_tag} src={glance_sub.glance_icon}></img>
                                                    <p className='box_para'  dangerouslySetInnerHTML={{ __html: glance_sub.glance_para }}></p>
                                                    <p className='box_num_para' dangerouslySetInnerHTML={{ __html: glance_sub.glance_big_hd }}></p>
                                                </div>
                                            </div>
                                        )}

                                        {/* <div className='box-one two'>
                                            <img className='box_img' src={require('../../../assets/img/svg/drive_1.svg').default}></img>
                                            <p className='box_para'>Open Area for Utilities:</p>
                                            <p className='box_num_para'>24, 801 Sq. Ft.</p>
                                        </div>

                                        <div className='box-one three'>
                                            <img className='box_img' src={require('../../../assets/img/svg/solar-panel_1.svg').default}></img>
                                            <p className='box_para'>Roof Top Solar Capacity:</p>
                                            <p className='box_num_para'>7,50,000 Watts</p>
                                        </div>

                                        <div className='box-one four'>
                                            <img className='box_img' src={require('../../../assets/img/svg/co2_1.svg').default}></img>
                                        ...
                                        <div className='box-one five'>
                                            <img className='box_img' src={require('../../../assets/img/svg/clock_1.svg').default}></img>
                            ...
                            <div className='cstm_container case-std'>
                                ...
                                <div className='row no_LR_margin' >
                                    <div className='col-12'>
                                        ...
                                        <h2 className='info_hd_txt' dangerouslySetInnerHTML={{ __html: acf.solution_title }}></h2>
                                        <p className='para ovrview_para' dangerouslySetInnerHTML={{ __html: acf.solution_paragraph }}></p>
                        ...
                        <div className='cstm_container case-std key_forword'>
                            <div className='row no_LR_margin '>
                                ...
                                <div className='col-12'>
                                    ...
                                    <h2 className='section_sub_heading ovrview_sub_hd' dangerouslySetInnerHTML={{ __html: acf.key_title }}></h2>

                                    <p className='para ovrview_para clnt_ovrw_para' dangerouslySetInnerHTML={{ __html: acf.key_paragraph }} ></p>
                            ...
                            <div className='cstm_container case-std'>
                                <div className='row no_LR_margin '>
                                    ...
                                    <div className='col-12'>
                                        ...
                                        <h2 className='section_sub_heading ovrview_sub_hd btm_hd' >Gallery</h2>
