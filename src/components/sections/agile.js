                    ...
                    <div className='row col_row_2'>
                        <div className='col-lg-6 col-md-6 col-12'>
                            ...
                            <div className='reveal_img'>
                                ...
                                <video className='agile_img gloabl_video' controls playsInline loop muted src={require('../../assets/video/Horizon_Industrial_Parks_Brand_Manifesto1.mp4')} ref={videoEl} />
