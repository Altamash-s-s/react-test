        ...
        <div className='cstm_container'>
            <div className='row'>
                <div className='col-12'>
                    <h2 className='section_sub_heading ovrview_sub_hd customise_hd'>STRATEGIC LAND ACQUISITION</h2>
            ...
            <div className='row sip_img_cnt_row'>
                <div className='col-lg-4 col-md-12 col-12 sip_img_col'>
                    <div className='sip_img_dv'>
                      <img src={require('../../../../assets/img/solutions_inside/Strategic_land/Strategic_land_info_img.jpg')} alt='Strategic land acquisition'></img>
                    </div>
                </div>
