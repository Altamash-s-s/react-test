        ...
        <div className='cstm_container'>
            <div className='row'>
                <div className='col-12'>
                    <h2 className='section_sub_heading ovrview_sub_hd customise_hd'>PROPERTY MANAGEMENT</h2>
                    <p className='sub_para'>Our property management team's key duties include managing the upkeep of all our facilities and ensuring 24x7 operations for our customers.
</p>
                </div>
            </div>
            <div className='row sip_img_cnt_row'>
                <div className='col-lg-4 col-md-12 col-12 sip_img_col'>
                    <div className='sip_img_dv'>
                      <img alt='Hiparks wareshouse management services' src={require('../../../../assets/img/solutions_inside/proprty_mang/proprty_mang_info.jpg')}></img>
                    </div>
                </div>
                <div className='col-lg-8 col-md-12 col-12 sip_cntn_col'>
                    <div className='sip_cntn_dv_sec1'>
