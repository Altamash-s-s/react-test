            ...
            <div className='row no_LR_margin'>
                ...
                <div className='col-lg-5 col-md-6 col-sm-12 col-12  park_map_col'>
                    ...
                    <div className='park_inner_dv mobile_prk_dv'>
                        <p className='section_name map_sec_name p_opacity' ref={fade_para} id='fade_para'>Our Reach</p>
                        <hr className='add_border p_opacity' ref={parkBorder_aniamtion} id='parkBorder_aniamtion'/>
                        <div className="animate_txt ">
                            <h2 ref={txt_animate_3} className='section_heading' id='txt_animate_3'>Grow your world</h2>
                        </div>
                        <div className="animate_txt ">
                            <h2 ref={txt_animate_3} className='section_heading' id='txt_animate_3'>In Ours</h2>
                        </div>
                    </div>

                    <div className='map_dv'>
                        <img className='map_img' src={require('../../assets/img/map.webp')}></img>

                        {/*--------------- Delhi */}
                        <div className='state_dv park_state ncr_dv' ref={pin_animate_1} id='pin_animate_1' target="1">
                            <div className='sd_name_box' >
                                <p className='state_name'>Delhi NCR</p>
                            </div>
                            <div className='sd_pin_box' >
                                <img src={require('../../assets/img/svg/white_map_pin.svg').default}></img>
                        ...
                        {/*--------------- Ahmedabad */}
                        <div className='state_dv park_state ahmedabad_dv' ref={pin_animate_2} id='pin_animate_2' target="2">
                            <div className='sd_pin_box' >
                                <img src={require('../../assets/img/svg/white_map_pin.svg').default}></img>
                                <div className='park_no_dv'>
                        ...
                        {/*--------------- Indore    */}
                        <div className='state_dv indore_dv' ref={pin_animate_4} id='pin_animate_4'  target="">
                            <div className='sd_name_box'>
                                <p className='state_name'>Indore</p>
                            </div>
                            <div className='sd_pin_box'>
                                <img src={require('../../assets/img/svg/green_map_pin.svg').default}></img>
                                <div className='park_no_dv'>
                                    <p className='park_no'>01</p>
                                </div>
                            </div> 
                        ...
                        {/*--------------- Nashik    */}
                        <div className='state_dv nashik_dv' ref={pin_animate_4} id='pin_animate_4'  target="">
                            <div className='sd_name_box'>
                                <p className='state_name'>Nashik</p>
                            </div>
                            <div className='sd_pin_box'>
                                <img src={require('../../assets/img/svg/orange_map_pin.svg').default}></img>
                                <div className='park_no_dv'>
                                    <p className='park_no'>01</p>
                                </div>
                            </div> 
                        ...
                        {/*--------------- Mumbai */}
                        <div className='state_dv mumbai_dv' ref={pin_animate_4} id='pin_animate_4'  target="3">
                            <div className='sd_name_box'>
                        ...
                        {/*--------------- Pune */}
                        <div className='state_dv park_state pune_dv' ref={pin_animate_6} id='pin_animate_6' target="4">
                            <div className='sd_pin_box' >
                                <img src={require('../../assets/img/svg/white_orange_map_pin.svg').default}></img>
                                <div className='park_no_dv'>
                        ...
                        {/*--------------- Goa */}
                        <div className='state_dv park_state goa_dv' ref={pin_animate_8} id='pin_animate_8' target="5">
                            <div className='sd_name_box' >
                        ...
                        {/*--------------- Bengaluru */}
                        <div className='state_dv park_state bengaluru_dv' ref={pin_animate_9} id='pin_animate_9' target="6">
                        ...
                        {/*--------------- Chennai */}
                        <div className='state_dv chennai_dv' ref={pin_animate_7} id='pin_animate_7' target="">
                            <div className='sd_pin_box' >
                                <img src={require('../../assets/img/svg/orange_map_pin.svg').default}></img>
                                <div className='park_no_dv'>
                                    <p className='park_no'>01</p>
                        ...
                        {/*--------------- Hyderabad */}
                        <div className='state_dv park_state hyderabad_dv' ref={pin_animate_7} id='pin_animate_7' target="7">
                            <div className='sd_pin_box' >
                                <img src={require('../../assets/img/svg/white_map_pin.svg').default}></img>
                                <div className='park_no_dv'>
                                    <p className='park_no'>02</p>
                        ...
                        {/*--------------- Nagpur */}
                        <div className='state_dv park_state nagpur_dv' ref={pin_animate_5} id='pin_animate_5' target="8">
                            <div className='sd_pin_box' >
                                <img src={require('../../assets/img/svg/white_green_map_pin.svg').default}></img>
                                <div className='park_no_dv'>
                                    <p className='park_no'>02</p>
                                </div>
                            </div> 
                        ...
                        {/*--------------- Kolkata */}
                        <div className='state_dv kolkata_dv' ref={pin_animate_3} id='pin_animate_3' target="9">
                            <div className='sd_name_box'>
                        ...
                        <div className='park_active_status_dv p_opacity' ref={fade_para} id='fade_para'>
                            <div>
                                <img src={require('../../assets/img/white_pin.png')}></img>
                                <p>ACTIVE / Under Construction</p>
                            </div>
                            <div>
                                <img src={require('../../assets/img/green_pin.png')}></img>
                                <p>PLanned Acquisitions</p>
                            </div>
                            <div>
                                <img src={require('../../assets/img/orange_pin.png')}></img>
                                <p>JV PARKS</p>
                            </div>
                        </div>
                ...
                <div className='col-lg-7 col-md-6 col-sm-12 col-12 park_slider_col no_right_padding'>
                    <div className='park_inner_dv '>
                        <p className='section_name map_sec_name p_opacity mob_hide' ref={fade_para} id='fade_para'>Our Reach</p>
                        <hr className='add_border p_opacity mob_hide' ref={parkBorder_aniamtion} id='parkBorder_aniamtion'/>
