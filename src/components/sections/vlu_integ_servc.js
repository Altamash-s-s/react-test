    ...
    <>
        ...
        <div className='cstm_container'>
                    ...
                    <div className='col-12 vlu_box_pd'>
                        ...
                        <div className='row'>
                            <div className='col-lg-6 col-md-6 col-12 no_padding vlu_col1'>
                                <a href='/solutions/strategic-land-acquisition' className=''>
                                        ...
                                        <div className='vlu_intg_srvc_inner'>
                                            ...
                                            <div className='srvc_content '>
                                                ...
                                                <div>
                                                    ...
                                                    <a href='/solutions/strategic-land-acquisition' className='ladn_acq_btn'>Read More</a>
                                                </div>  
                                            </div>
                            ...
                            <div className='col-lg-6 col-md-6 col-12 no_padding vlu_col2'>
                                <a href='/solutions/park-compliances-and-approvals'>
                                        ...
                                        <div className='vlu_intg_srvc_inner'>
                                            ...
                                            <div className='srvc_content licensing_content '>
                                                ...
                                                <div>
                                                    ...
                                                    <a href='/solutions/park-compliances-and-approvals'>Read More</a>
                                                </div>  
                                            </div>
                                            <div className='ovrlay_box'></div>
                                        </div>
                            ...
                            <div className='col-lg-6 col-md-6 col-12 no_padding vlu_col3'>
                                <a href='/solutions/park-construction-and-development'>
                                        ...
                                        <div className='vlu_intg_srvc_inner'>
                                            ...
                                            <div className='srvc_content '>
                                                ...
                                                <div>
                                                    ...
                                                    <a href='/solutions/park-construction-and-development'>Read More</a>
                                                </div>  
                                            </div>
                                            <div className='ovrlay_box'></div>
                                        </div>
                            ...
                            <div className='col-lg-6 col-md-6 col-12 no_padding vlu_col4'>
                                <a href='/solutions/property-management'>
                                        ...
                                        <div className='vlu_intg_srvc_inner'>
                                            ...
                                            <div className='srvc_content oprations_contnt'>
                                                ...
                                                <div>
                                                    ...
                                                    <a href='/solutions/property-management'>Read More</a>
                                                </div>  
                                            </div>
                                            <div className='ovrlay_box'></div>
                                        </div>
            ...
            {/* <div className='vlu_integ_sld_box '>
                    ...
                    <img className='close_sld_box' src={require('../../assets/img/svg/close_icon_wht.svg').default}></img>
