    ...
    <div className='leadership_sec mob_pd_LR tab_pd_LR' id='leadership'>
      ...
      <div className='cstm_container'>
        ...
        <div className='row'>
          ...
          <div className='col-lg-6 col-md-6 col-12'>
            <p className='sub_para ovrview_subpara leadership_ttl_1 p_opacity' ref={leader_para} id='leader_para'>We see things differently, find opportunities proactively and with an agile team, create exceptional value for our customers, partners and employees.</p>
          </div>
        </div>
      ...
      <div className='team_row_sec'>
        ...
        <div className='team_slidebox'>
          <img className='close_tm_box' src={require('../../assets/img/svg/close_icon.svg').default}></img>
                ...
                <div className='row'>
                  <div className='col-lg-8 col-md-12 col-12 tm_fullcontent_col'>
                    ...
                    <div className='tm_p_dv'>
                      ...
                      {/* <p className='para'>He is a Member of the CII National Committee on Tourism and a Member of the Rental Housing Association of India. Hotelier India featured Rahul on its annual Indian Hospitality Power List in 2017. Rahul is a former member of the Indian Karate Team and serves as an Independent Director on the Board of Ixigo, a travel e-commerce company.</p> */}


                    </div>
                    <a className='linkedin_box' href='https://www.linkedin.com/in/rahulpandit1/' target='_blank'>
                      <img src={require('../../assets/img/svg/linkedin_icon.svg').default} ></img>
                    </a>
                  </div>
              ...
              <div className='narayn_cont tm_cont_box'>
                ...
                <div className='row'>
                  <div className='col-lg-8 col-md-12 col-12 tm_fullcontent_col'>
                    ...
                    <div className='tm_p_dv'>
                      <p className='para'>RK's expertise in facilitating expansion through partnerships and acquisitions and maximizing ROI is enabling Horizon’s growth. RK has over 27 years of experience. Previously, he served as the COO at All Cargo Logistics & Industrial Parks and has earlier worked with the private equity and investment banking teams at JM Financial and the Macquarie group.</p>
              ...
              <div className='kunal_cont tm_cont_box'>
                ...
                <div className='row'>
                  <div className='col-lg-8 col-md-12 col-12 tm_fullcontent_col'>
                    ...
                    <div className='tm_p_dv'>
                      <p className='para'>Kunal is a Chartered Accountant with over two decades of experience in leading finance, accounts and business transformation practices with various Indian companies and consulting majors. </p>
              ...
              <div className='aviraj_cont tm_cont_box'>
                ...
                <div className='row'>
                  <div className='col-lg-8 col-md-12 col-12 tm_fullcontent_col'>
                    ...
                    <div className='tm_p_dv'>
                      <p className='para'>He has more than 25 years of experience in implementing workforce changes, organization design and talent management in South Asia with leading companies in India. In his previous experience, he has been an entrepreneur at his venture in Latvia, Europe and was earlier serving as Vice President HR at PVR Ltd. Aviraj has held leadership assignments with VFS Global Services Pvt Ltd, DLF Ltd, Govt of India and is a military veteran.</p>

                      <p className='para'>He is an alumnus of National Defence Academy, Indian Military Academy and holds a master’s Diploma from Symbiosis Institute of Management Studies, Pune.</p>
              ...
              <div className='taruna_cont tm_cont_box'>
                ...
                <div className='row'>
                  <div className='col-lg-8 col-md-12 col-12 tm_fullcontent_col'>
                    ...
                    <div className='tm_p_dv'>
                      <p className='para'>She has two decades of experience in leading integrated marketing communications strategies, customer experience and brand shaping to expand the growth agenda of different Indian companies. Previously, she served as Assistant Vice President of Marketing at IndoSpace, and she spent close to a decade at TVS Supply Chain Solutions as Head of Marketing and Communications focused on brand building, post M&A transition &integration, marketing and corporate communications to augment sales and customer engagement.</p>
              ...
              <div className='swati_cont tm_cont_box'>
                ...
                <div className='row'>
                  <div className='col-lg-8 col-md-12 col-12 tm_fullcontent_col'>
                    ...
                    <div className='tm_p_dv'>
                      <p className='para'>She has 15 years of experience in managing legal affairs related to corporate and real estate matters and transaction support, partnerships and risk management. Previously, she served as General Manager in the Legal department at Lodha Group and for a decade, she worked with multi-disciplinary law firms in India to counsel customers on documentation, compliance regulations, law and governance matters. </p>
              ...
              <div className='mitesh_cont tm_cont_box'>
                ...
                <div className='row'>
                  <div className='col-lg-8 col-md-12 col-12 tm_fullcontent_col'>
                    ...
                    <div className='tm_p_dv'>
                      <p className='para'>Mitesh has over 22 years of experience in directing cross-functional teams in the design and integration of leading-edge technology solutions. Previously, he served as Head of IT at Smollan India - a retail solutions company - and was involved in developing and expanding the firm’s technology services offerings across various geographies. </p>
