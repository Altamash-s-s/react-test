    ...
    const sendEmail = async (e) => {
        ...
        if (name_fld == '') {
            ...
            if (dprt_fld === 'Leasing') {
                ...
                fetch('https://script.google.com/macros/s/AKfycbz22_jhxDq5iLt3LiKuAkQwnEgjknAJofrKxLqX2hiyt1A8UkEK1BtXGhmBgfG_9iAo/exec', {
                    method: 'POST',
                ...
                <div className='row cstm_container'>
                    <div className='col-lg-12 col-md-12 col-12 ing_solu_col_1 convert_form_col1'>
                        ...
                        <div className='prkinside_form'>
                            <form className="row g-3 conversion_form" ref={form} onSubmit={sendEmail} id='enq_form_bx'>

                                <input className='page_name' type='hidden' name='Page_name' value='Contact Page' />
                                ...
                                <div className="col-md-6 conv_frm_spc">
                                    ...
                                    <input type="text" name='name' className="form-control" id='name_fld' ref={nameinput} onFocus={handleFocus} />
                                ...
                                <div className="col-md-6 conv_frm_spc">
                                    ...
                                    <input type="text" name='organisation' className="form-control" id='org_fld' ref={orginput} onFocus={handleFocus} />
                                ...
                                <div className='col-md-6 conv_frm_spc selectin-fld'>
                                    ...
                                    <select className='form-control enq_type cont_enq' name='enquiry' id='dprt_fld' ref={departinput} onFocus={handleFocus}  >
                                    ...
                                    <p className='error_msg' id='depart_err'>Please Select Type of Enquiry</p>
                                </div>
                                ...
                                <div className="col-md-6 conv_frm_spc pkr_lc_fld_dv">
                                    ...
                                    <p className='error_msg' id='prk_err_lsng'>Please Enter Park Location</p>
                                </div>
                                <div className="col-md-6 conv_frm_spc spc_rq_fld_dv">
                                    ...
                                    <p className='error_msg' id='spc_err_lsng'>Please Enter Space</p>
                                </div>
                                ...
                                <div className="col-6 conv_frm_spc tell_sec">
                                    ...
                                    <textarea className="form-control msg_input" name='message' id='msg_fld' placeholder="Enter your message" ref={msginput} onFocus={handleFocus} rows="4" cols="50"></textarea>
