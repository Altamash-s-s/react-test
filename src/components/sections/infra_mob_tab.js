                                        ...
                                        <div id="accordion" className='accord_dv p_opacity' ref={accordion} >
                                                <div className="card intg_card">
                                                    ...
                                                    <div id="collapseOne" className="collapse show" data-bs-parent="#accordion">
                                                        <div className="card-body intg_card_body_desc">
                                                            <p className='accord_para'>Standing seam roof with sturdy bare galvalume sheets for bearing load of solar panels</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="card intg_card">
                                                    ...
                                                    <div id="collapseFive" className="collapse" data-bs-parent="#accordion">
                                                        <div className="card-body intg_card_body_desc">
                                                            <p className='accord_para'>Ground and cold-shell mezzanine floor on 2.5% of total area</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="card intg_card">
                                                    ...
                                                    <div id="collapseSeven" className="collapse" data-bs-parent="#accordion">
                                                        <div className="card-body intg_card_body_desc">
                                                            <p className='accord_para'>2- and 4-wheeler parking near park entry and building entrance. Truck parking designed for peak period load</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="card intg_card">
                                                    ...
                                                    <div id="collapseEight" className="collapse" data-bs-parent="#accordion">
                                                        <div className="card-body intg_card_body_desc">
                                                            <p className='accord_para'>24* 7 CCTV surveillance at park entry and exit points. Security kiosks and check points at strategic locations.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                        </div>
                                    ...
                                    <div id="accordion2" className='accord_dv p_opacity' ref={accordion2} >
                                                <div className="card intg_card">
                                                    ...
                                                    <div id="collapseOne2" className="collapse show" data-bs-parent="#accordion2">
                                                        <div className="card-body intg_card_body_desc">
                                                            <p className='accord_para'>Skylights 3-5% of roof areas. LED light fixtures, PV cells and 100% backup for lighting of common areas and amenities</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="card intg_card">
                                                    ...
                                                    <div id="collapseTwo2" className="collapse" data-bs-parent="#accordion2">
                                                        <div className="card-body intg_card_body_desc">
                                                            <p className='accord_para'>Pre-cast concrete walls up to 3.6m height</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="card intg_card">
                                                    ...
                                                    <div id="collapseThree3" className="collapse" data-bs-parent="#accordion2">
                                                        <div className="card-body intg_card_body_desc">
                                                            <p className='accord_para'>Uniformly distributed load 5T/sqm. Flat floors, FM2 compliant design</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="card intg_card">
                                                    ...
                                                    <div id="collapseFour4" className="collapse" data-bs-parent="#accordion2">
                                                        <div className="card-body intg_card_body_desc">
                                                            <p className='accord_para'>Fire detections, alarm and fire escape doors as per norms. K115 type roof sprinkler, K80 type mezzanine sprinklers and external hydrants.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="card intg_card">
                                                    ...
                                                    <div id="collapseFive5" className="collapse" data-bs-parent="#accordion2">
                                                        <div className="card-body intg_card_body_desc">
                                                            <p className='accord_para'>3-6 air changes per hour as per NBC norms. Passive ventilation through louvers and roof monitors</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="card intg_card">
                                                    ...
                                                    <div id="collapseSeven7" className="collapse" data-bs-parent="#accordion2">
                                                        <div className="card-body intg_card_body_desc">
                                                            <p className='accord_para'>Dock height 1.2m with rolling shutters and dock pits.</p>
                                                        </div>
                                                    </div>
                                                </div>
