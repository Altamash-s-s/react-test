...
export default function Coversation_form() {
    ...
    $(document).ready(function () {
        ...
        if (url === '/parks/delhi-ii') {
            let pg_name = 'delhi-ii';
            $('#page_name').val(pg_name);
        }

        if (url === '/parks/bilaspur-i') {
            let pg_name = 'bilaspur-i';
            $('#page_name').val(pg_name);
        }

        if (url === '/parks/bilaspur-ii') {
            let pg_name = 'bilaspur-ii';
            $('#page_name').val(pg_name);
        }
        ...
        if (url === '/parks/chakan-ii') {
            let pg_name = 'chakan-ii';
            $('#page_name').val(pg_name);
        }

        if (url === '/parks/chakan-v') {
            let pg_name = 'chakan-v';
            $('#page_name').val(pg_name);
        }
        ...
        if (url === '/parks/patancheru') {
            let pg_name = 'patancheru';
            $('#page_name').val(pg_name);
        }

        if (url === '/parks/dobbaspet-i') {
            let pg_name = 'dobbaspet-i';
            $('#page_name').val(pg_name);
        }

        if (url === '/parks/dobbaspet-ii') {
            let pg_name = 'dobbaspet-ii';
            $('#page_name').val(pg_name);
        }
