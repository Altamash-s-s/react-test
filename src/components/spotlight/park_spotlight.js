                        ...
                        <div className='spotlight_content_box'>
                            <div className='spotlight_inner_content'>
                                {/* <div className='prk_dtl_line1'>
                                    <p className='section_sub_heading'>Reimagining parks as social cohorts</p>
                                </div> */}
                                <div className='prk_dtl_line2'>
                                    <h1 className='big_heading esg_heading_ttl' ref={spot_hd_anmt} id='spot_hd_anmt'>Reimagining parks as <br></br> social cohorts</h1>
                                </div>
                            </div>
                        </div>
                    </div>
