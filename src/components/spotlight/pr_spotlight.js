  ...
  return (
    <>
        <div className='park_inside_spotlight_sec'>
                        ...
                        <div className='spotlight_content_box'>
                            <div className='spotlight_inner_content'>
                                ...
                                <div className='prk_dtl_line2 contact_anmt'>
                                    <h1 className='big_heading esg_heading_ttl' ref={spot_hd_anmt_cont} id='spot_hd_anmt_cont'>Press Release</h1>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <img src={require('../../assets/img/press_release.jpg')} className='park_inside_bg_img contact_spotlight_img'></img>
